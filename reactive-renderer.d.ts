...
declare module 'reactive-renderer/lib/types' {
	...
	export { BaseBlueprint, BasePropsType, InstanceTreeType, IParentableBy, IContextBase, RenderableType, ICommonBlueprintBase, ComponentType, ComponentWithContextType };
