...
declare module 'reactive-renderer/lib/__unittests__/Logger' {
	import { BaseBlueprint, BasePropsType } from 'reactive-renderer/lib/';
...
declare module 'reactive-renderer/lib/__unittests__/Renderer/Components/fakeRoot' {
	...
	import { Blueprint, IParentableBy, BasePropsType, _RenderableType, _IParentableBy, BaseBlueprint, InstanceTreeType } from 'reactive-renderer/lib/__unittests__/Renderer/Components/types';
	import { ICommonBlueprintBase } from 'reactive-renderer/lib/__unittests__/Renderer/CommonBlueprintBase';
...
declare module 'reactive-renderer/lib/__unittests__/Renderer/Components/types' {
	 ...
	 */
	import { BaseBlueprint, BasePropsType, IParentableBy as _IParentableBy, RenderableType as _RenderableType, InstanceTreeType as _InstanceTreeType, BaseRootRenderableType } from 'reactive-renderer/lib';
	import { _FakeRoot } from 'reactive-renderer/lib/__unittests__/Renderer/Components/fakeRoot';
	import { default as _Logger, LogItem as _LogItem } from 'reactive-renderer/lib/__unittests__/Logger';
	import { ICommonBlueprintBase } from 'reactive-renderer/lib/__unittests__/Renderer/CommonBlueprintBase';
	...
	export type RootRenderableType = BaseRootRenderableType<_FakeRoot, ICommonBlueprintBase>;
...
declare module 'reactive-renderer/lib/__unittests__/Renderer/FakeRenderer' {
	import { BaseRenderer } from 'reactive-renderer/lib';
	import { ICommonBlueprintBase } from 'reactive-renderer/lib/__unittests__/Renderer/CommonBlueprintBase';
	import { InstanceTreeType, Logger, RootRenderableType } from 'reactive-renderer/lib/__unittests__/Renderer/Components/types';
	...
	export default class FakeRenderer extends BaseRenderer<_FakeRoot, FakeRootPropsType, ICommonBlueprintBase> {
	    ...
	    render(toRender: RootRenderableType | null, rootProps?: FakeRootPropsType): void;
	    dispose(): void;
	}

}
declare module 'reactive-renderer/lib/__unittests__/Renderer/Components/Grandparent' {
	import { BasePropsType } from 'reactive-renderer/lib';
	import { _FakeRoot } from 'reactive-renderer/lib/__unittests__/Renderer/Components/fakeRoot';
	import { Blueprint, IParentableBy, RenderableType, Logger, InstanceTreeType } from 'reactive-renderer/lib/__unittests__/Renderer/Components/types';
...
declare module 'reactive-renderer/lib/__unittests__/Renderer/Components/Layer' {
	...
	import Logger from 'reactive-renderer/lib/__unittests__/Logger';
	import { ICommonBlueprintBase } from 'reactive-renderer/lib/__unittests__/Renderer/CommonBlueprintBase';
	import { Blueprint, IParentableBy, RenderableType, InstanceTreeType } from 'reactive-renderer/lib/__unittests__/Renderer/Components/types';
...
declare module 'reactive-renderer/lib/__unittests__/Renderer/Components/Child' {
	...
	import { Blueprint, IParentableBy, Logger, RenderableType, InstanceTreeType } from 'reactive-renderer/lib/__unittests__/Renderer/Components/types';
