...
declare module 'reactive-renderer/lib/types' {
	...
	import { ICommonBlueprintBase } from 'reactive-renderer/lib/types/ICommonBlueprintBase';
	import { RenderableType } from 'reactive-renderer/lib/types/Renderable';
	import { ComponentType } from 'reactive-renderer/lib/types/Component';
	export { BaseBlueprint, BasePropsType, InstanceTreeType, IParentableBy, IContextBase, RenderableType, ICommonBlueprintBase, ComponentType };

}
declare module 'reactive-renderer/lib/BaseRenderer' {
	import { BaseBlueprint, BasePropsType, IParentableBy, RenderableType, ICommonBlueprintBase, IContextBase, InstanceTreeType } from 'reactive-renderer/lib/types';
...
declare module 'reactive-renderer/lib/createComponentWithContext' {
	...
	export function createComponentWithContext<BlueprintClass extends BaseBlueprint<PropsType, ICommonBlueprint, IContext> & IParentableBy<ParentableTypes, ICommonBlueprint> & ICommonBlueprint, ParentableTypes extends BaseBlueprint<BasePropsType, ICommonBlueprint, IContextBase>, PropsType extends BasePropsType, ICommonBlueprint extends ICommonBlueprintBase, IContext extends IContextBase>(blueprintClass: {
	    new (): BlueprintClass & IParentableBy<ParentableTypes, ICommonBlueprint>;
	}): ComponentType<BlueprintClass, ParentableTypes, PropsType, ICommonBlueprint, IContext>;
...
declare module 'reactive-renderer' {
	...
	import { BaseBlueprint, BasePropsType, InstanceTreeType, IContextBase, IParentableBy, ICommonBlueprintBase, RenderableType, ComponentType } from 'reactive-renderer/lib/types';
	export { BaseRenderer, BaseRootRenderableType, renderChild, deleteChild, createComponent, createComponentWithContext, ComponentType, BaseBlueprint, BasePropsType, InstanceTreeType, IContextBase, IParentableBy, ICommonBlueprintBase, RenderableType };
