...
describe('[Renderer]', () => {
    it('... should corrently init, update, and remove one-depth', () => {
        ...
        logger.partialMatch([new Logger_1.LogItem({
        ...
        loggerAfterGrandparentInit.partialMatch([new Logger_1.LogItem({ blueprint: _Layer, type: 'init' }), new Logger_1.LogItem({
            blueprint: _Layer,
            type: 'init'
        }), new Logger_1.LogItem({
            blueprint: _Layer,
        ...
        loggerAfterDeletion.partialMatch([new Logger_1.LogItem({
            blueprint: _Layer,
            type: 'delete'
        }), new Logger_1.LogItem({
            blueprint: _Layer,
